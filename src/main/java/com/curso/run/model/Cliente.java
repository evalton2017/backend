...
public class Cliente implements Serializable {
	...
	//JsonManagedReference **foi retirado e substituido por JsonIgnore na classe associada
	...
	//metodos para adicionar  e retornar os perfis
	public Set<Perfil> getPerfis(){
		return perfis.stream().map(elemento -> Perfil.toEnum(elemento)).collect(Collectors.toSet());
	}
